...
HOOKS_API = f'https://api.blockcypher.com/v1/eth/main/hooks?token={e605245f670e44d99b5092f7981b882d}'
...
def increase_user_deposit():
    ...
    try:
        ...
        return Response(
            response='Not like a fractional number',
            status=400,
            mimetype='application/json'
        )
...
def approve_withdrawal():
    ...
    if withdrawal.approved:
        return Response(
            response='The conclusion has already been confirmed',
            status=400,
            mimetype='application/json'
        )
...
def top_up_received():
    ...
    if top_up.received:
        return Response(
            response='Replenishment is already credited',
            status=400,
            mimetype='application/json'
        )
    try:
